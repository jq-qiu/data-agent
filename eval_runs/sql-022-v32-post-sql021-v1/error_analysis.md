# sql-022-v32-post-sql021-v1 Error Analysis

Failed cases: 17/30
Compatible result mismatches: 7
Strict result mismatches: 7
Trace deviations: 16
...
- Error: result or structure mismatch
- Failure labels: Metric Recognition Error, Grain Contract Error
- Compatible execution match: True
- Strict execution match: 1.0
- Trace conformance: False
- Grain contract: 0.0
...
## T04 - SQL Generation Error

- Bucket: time
- Question: 2018年第二季度的AOV是多少
- Error: AOV must be recomputed from region-DWS GMV and order count
...
## C03 - Schema Linking Error

- Bucket: comparison
- Question: 对比圣保罗州2018年4月和5月的GMV
- Error: result or structure mismatch
- Failure labels: Schema Linking Error
- Compatible execution match: True
- Strict execution match: 1.0
...
- Error: function is not allowlisted: case
